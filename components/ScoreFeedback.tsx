...
const ScoreFeedback: React.FC<ScoreFeedbackProps> = ({ result, isLoading = false, onEvaluate, canEvaluate, readOnly = false }) => {
  return (
    <div className={`mt-8 pt-6 ${!readOnly ? 'border-t border-gray-200' : ''}`}>
      {!result && !readOnly && (
      ...
      {result && (
        <div className="animate-fade-in-up mt-6 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          <div className="bg-primary/5 p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="p-6 grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 space-y-1 ml-1 bg-amber-50 p-4 rounded-lg border border-amber-100">
          ...
          {!readOnly && onEvaluate && (
            <div className="bg-gray-50 p-4 border-t border-gray-100 text-center">
               <button onClick={onEvaluate} className="text-primary hover:text-blue-700 text-sm font-medium hover:underline">
