        ...
        <React.Fragment key={idx}>
          {seg.type === 'correction' ? (
            <span className="relative group mx-0.5">
              ...
              {seg.explanation && (
                <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-gray-800 dark:bg-gray-700 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10 shadow-lg">
                  {seg.explanation}
                  <svg className="absolute top-full left-1/2 -translate-x-1/2 text-gray-800 dark:text-gray-700 h-2 w-full" x="0px" y="0px" viewBox="0 0 255 255">
